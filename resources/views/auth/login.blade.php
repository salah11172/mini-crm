...
{{-- </div>
    ...
    <div class="login-form my-5">
       <h5 class="text-primary fw-bolder "> if you admin you will login to dashboard<br><br>
         if you user you will login to laravel welcome page<br><br>
         is_admin Property differentiate between admin and user
